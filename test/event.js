...
*/
    it('should raise error with invalid slug', function (done) {
      var request;
      request = supertest(app);
      request = request.get('/events/invalid');
      request.expect(404);
      request.end(done);
    });
    ...
    it('should show', function (done) {
      var request;
      request = supertest(app);
      request = request.get('/events/matricula-do-primeiro-semestre');
      request.expect(200);
      request.expect(function (response) {
  ...
  describe('update', function () {
    ...
    it('should raise error without token', function (done) {
      var request;
      request = supertest(app);
      request = request.put('/events/matricula-do-primeiro-semestre');
...
*/
    it('should raise error with invalid slug', function (done) {
      var request;
      request = supertest(app);
      request = request.put('/events/invalid');
      request.set('csrf-token', 'adminToken');
      request.send({'name' : 'matricula do primeiro semestre 2'});
      request.expect(404);
      request.end(done);
...
//      request.send({'date' : new Date()});
  ...
  describe('delete', function () {
    ...
    it('should raise error without token', function (done) {
      var request;
      request = supertest(app);
      request = request.del('/events/matricula-do-primeiro-semestre');
      request.expect(403);
      request.end(done);
    });
...
*/
    it('should raise error with invalid slug', function (done) {
      var request;
      request = supertest(app);
      request = request.del('/events/invalid');
      request.set('csrf-token', 'adminToken');
      request.expect(404);
      request.end(done);
    });
